...
import { PlusCircleIcon , ArrowRightIcon ,ChartPieIcon , QueueListIcon} from "@heroicons/react/24/outline";
...
export default function Dashboard() {
  ...
  return (
    <>
          ...
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <div>
              <Card className="max-w-lg mx-auto">
                <Card>
                  <Flex>
                    <Text className="truncate">Records taken so far today</Text>
                  </Flex>
                  <Flex
      ...
      <Metric>{(leaves.pending_approval_leaves + leaves.approved_leaves)}</Metric>
      <Divider />
      <Text className="mt-4">
